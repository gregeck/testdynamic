...
<body>
        <div id="header">
            ...
            <h2 style="text-align: center">Automated Parsing &amp; Translation System</h2>
            <h2 style="text-align: center">For Mongolian, Tibetan &amp; Chinese</h2>
        </div>
    
        <div id="uploader" class="span-12">
            <form id="form1" runat="server">
                <fieldset>
				<img id="side_img" style="float:right" src="images/Mongolian.jpg" alt="Mongolian text goes here">
				<img id="side_img" style="float:right" src="images/Chinese.jpg" alt="Chinese text goes here">
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True">
                        ...
                        <asp:ListItem Value="O12" >Download Mongolian Font Specification files</asp:ListItem>
                        <asp:ListItem Value="O99" Selected="True">SELECT AN OPTION</asp:ListItem>
                    </asp:DropDownList>
                    </p>
                    <p style="float:left">
                    <label><b>Source Language</b></label><br />
                    ...
                    <p style="float:left">
                    <label><b>Target Language</b></label><br />
		    ...
		    <img id="tbn_img" src="images/Tibetan.jpg" alt="Tibetan text goes here">
                </fieldset>
        ...
        <div id="help" class="span-24 last">
			...
			<h3>Contract Work</h3>
            <ul>
                <li>For an estimate on Mongolian, Tibetan or Chinese translation</li>
                <li>Contact Greg Eck at    g r e y s o n @ p o s t o n e . n e t</li>
            </ul>
			</div>
			<div style="float: left">
            <h3>Help</h3>
            <ul>
                ...
                <li>Partnerships Available ᠨᠣᠮ ᠪᠠᠶᠢᠨᠠ᠎ᠠ </li>
